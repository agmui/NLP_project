...
public class CParser extends Parser {
	...
	public static final int
		...
		StringLiteral=108, AsmBlock=109, Directive=110, Whitespace=111, Newline=112, 
		EscapeNewline=113, BlockComment=114, LineComment=115;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"StringLiteral", "AsmBlock", "Directive", "Whitespace", "Newline", "EscapeNewline", 
